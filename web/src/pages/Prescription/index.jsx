...
function PrescriptionDocument({ patientName, text}) {
...
export function Prescription() {
    ...
    if (error) {
        ...
        return (
            <>
                <Helmet>
                    <title>Emitir Receituário | Lutea</title>
                </Helmet>
                <main className="px-16 py-6">
                    <Header />
                    <div className="2xl:py-32 xl:py-16 lg:py-8 gap-2 grid">
                        <h1 className="font-bold text-pink-700 text-4xl">Emitir Receituário</h1>
                        <span className="text-gray-500">Preencha os campos a seguir para emitir um receituário.</span>
                    </div>
                    <div className="grid">
                            ...
                            <section className="grid gap-8">
                                <div className="grid">
                                    ...
                                    <input
                                        type="text"
                                        name="patientName"
                                        className="w-96 outline outline-1 outline-pink-200 py-2 px-4 rounded-sm"
                                ...
                                <div className="grid" >
                                    <label
                                        className="font-medium pb-2"
                                        htmlFor="prescriptionText">Prescrição</label>
                                    <textarea
                                        className="outline outline-1 outline-pink-200 px-4 py-2 text-gray-500 rounded-sm w-full"
                                        name="prescriptionText"
                                        placeholder="Digite aqui a prescrição de medicamentos"
                                        title="prescriptionText"
                        ...
                        <div className="flex gap-4 pt-4 pb-8">
                            <PDFDownloadLink document={
                                ...
                                />}
                                fileName={`receituario-${patientName}_${new Date().toISOString()}.pdf`}>
                                <button
                                    type="button"
                                    className="bg-pink-700 px-4 py-2 font-medium text-white rounded w-max"
                                    onClick={PrescriptionDocument}
                                >
                                    Emitir Receituário
                                </button>
                            </PDFDownloadLink>
