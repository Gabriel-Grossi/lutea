...
export function CancelAppointment() {
    ...
    async function cancelAppointment(event) {
        ...
        try {
            await api.patch('/appointment/cancel', {
                patientName,
                dateTime,
                doctor,
                type
    ...
    return (
        <>
            <Helmet>
                <title>Cancelar Consulta | Lutea</title>
            </Helmet>
            <main className="px-16 py-6">
                <Header />
                <div className="2xl:py-32 xl:py-16 lg:py-8 gap-2 grid">
                    <h1 className="font-bold text-pink-700 text-4xl">Cancelar Consulta</h1>
                    <span className="text-gray-500">Preencha os campos a seguir para cancelar consulta.</span>
                </div>
